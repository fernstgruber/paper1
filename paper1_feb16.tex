...
\subsection{Overall performance with regard to emulation surveyed topographic position}
...
Dominance of BS compared to other classes...  The low overall classification rate can be attributed to the generally high rate of misclassifications of other positions as BS. Maybe this is the surveyors "go-to class" when none of the other classes fits the topographic position adequately.
...
\subsection{Uncertainty of profile point localisation} 
To analyse whether certain points were consistenly classified wrongly, the number of times a data point was correctly classified in the six classification methods was investigated (Figure \ref{fig:hist_correct_per_tp}). The distribution of the number of correct classifications  shows that those points that were either always classified correctly  and those always misclassified dominate.
...
\subsection{Patterns in the algorithms regarding meso and macro and the grid resolution}
